...
//     .main-content-area { padding: 110px 24px 80px; width: 100%; max-width: 1536px; margin: 0 auto; }
...
//                     <i className="bi bi-arrow-left"></i> Back To Mentinance Hub
//                 </div>
//                  <header className="hub-header">
//                     <h1 >Daily Machine Logs</h1>
//                     <p >Standard daily maintenance and breakdown checksheets</p>
//                 </header>
//             </nav>
...
//                         <div key={report.id} className="reports-grid">
...
const MachineDailyReport = () => { 
    ...
    /* 🔥 Increased max-width so 4 cards fit beautifully on laptops */
    .main-content-area { padding: 50px 24px 80px; width: 100%; max-width: 1760px; margin-left:30px; }
...
`}</style>
        ...
        pointerEvents: 'none' /* Prevents header from blocking clicks */
                ...
                <h1  style={{ fontWeight: 900, color: '#3b82f6', fontSize: 'clamp(1.2rem, 3vw, 1.8rem)', margin: '0 0 4px 0' }} >Daily Machine Logs</h1>
                    <p className="text-muted" style={{ margin: 0, fontSize: '0.85rem' }} >Standard daily maintenance and breakdown checksheets</p>
                </header>
            </nav>
            ...
            <div className="main-content-area">
                ...
                <div className="reports-grid">
                    {machineDailyReports.map((report) => (
                        <div key={report.id} className="report-card-ui" onClick={() => handleCardClick(report)}>
                            <div className="card-header-line" style={{backgroundColor: report.color}}></div>
