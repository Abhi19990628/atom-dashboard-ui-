...
//   );
// }
// src/components/Plant2Live.js - COMPLETE WITH MODAL INTEGRATION & LAST COUNT TIME
import React, { useEffect, useState, useRef } from 'react';
import { useNavigate, useLocation } from 'react-router-dom'; 
...
// =================================================================================
// THEME VARIABLES (Exactly matching Plant 1)
// =================================================================================
const THEME_VARS = `
...
export default function Plant2Live() {
  ...
  // Sync theme with global layout (No inline toggles needed)
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '30px', padding: '24px', background: 'var(--header-bg)', borderRadius: '20px', border: '1px solid var(--header-border)', boxShadow: 'var(--card-shadow)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '15px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
            ...
            <h1 style={{ margin: 0, fontSize: '32px', color: 'var(--text-main)', fontWeight: '800' }}>Plant 2 <span style={{ color: 'var(--status-running)' }}>Live Status</span></h1>
          </div>
          <div style={{ display: 'flex', gap: '12px', fontSize: '14px', fontWeight: '600' }}>
